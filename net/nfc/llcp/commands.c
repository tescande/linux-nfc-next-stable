...
void nfc_llcp_free_sdp_tlv_list(struct hlist_head *head)
{
	...
	hlist_for_each_entry_safe(sdp, pos, n, head, node) {
		hlist_del(pos);
			    ...
			    struct hlist_head *tlv_list, size_t tlvs_len)
{
	...
	hlist_for_each_entry_safe(sdp, pos, n, tlv_list, node) {
			    ...
			    struct hlist_head *tlv_list, size_t tlvs_len)
{
	...
	hlist_for_each_entry_safe(sdreq, pos, n, tlv_list, node) {
		...
		hlist_add_head(pos, &local->pending_sdreqs);
	}
